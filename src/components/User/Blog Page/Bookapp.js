...
import $ from 'jquery';
import 'jquery-ui-dist/jquery-ui.min.css'; // Import the jQuery UI CSS
import 'jquery-ui-dist/jquery-ui.min'; // Import the jQuery UI JS
                ...
                <form id="form_create_appointment">
                  <div className="form-row">
                    <div className="col form-group">
                      ...
                      <input className="form-control date-input" type="text" id="date" data-trigger="hover" data-toggle="popover" title="Date" data-content="You can select any date from today clicking on the number in the calendar" required />
                    </div>
                    <div className="col form-group">
                  ...
                  <div className="form-row">
                    <div className="col form-group">
                      ...
                      <input className="form-control time-input" type="text" id="start_time" required />
                    </div>
                  ...
                  <div className="form-row">
                    ...
                    <div className="col form-group">
                      <button type="button" className="btn btn-primary btn-block" id="submit" onclick="make_appointment()" disabled="disabled">Make Appointment</button>
                    </div>
                  </div>
                </form>
              </div>
